              ...
              {item?.titles?.map((tiny, i) => (
                <>
                  {i % 2 === 0 ? (
                    <>
                      <div
                        className="pl-5 py-2 text-lg hover:text-secondary cursor-pointer"
                        key={tiny?.title}
                        style={{
                          borderBottomLeftRadius: `${tiny?.border}`,
                          borderBottomRightRadius: `${tiny?.border}`,
                        }}
                      >
                        <p>{tiny?.title}</p>
                      </div>
                    ...
                    <>
                      <div
                        className="pl-5 py-2 text-lg bg-gray-100  hover:text-secondary cursor-pointer"
                        key={tiny?.title}
                        style={{
                          borderBottomLeftRadius: `${tiny?.border}`,
                          borderBottomRightRadius: `${tiny?.border}`,
